...
namespace weixin.pay.BLL 
{
    public class JsApiPay
    {
        ...
        * 
        */
        public async Task GetOpenidAndAccessToken(string code,string redirectUrl)
        {
	    ...
	    */
        public async Task GetOpenidAndAccessTokenFromCode(string code)
        {
            try
            {
	    ...
	    */
        public string GetEditAddressParameters(string url)
	    {
            string parameter = "";
            try
            {
               //这个地方要注意，参与签名的是网页授权获取用户信息时微信后台回传的完整url
                ...
                byte[] dataHashed = sha.ComputeHash(Encoding.ASCII.GetBytes(param));
                string addrSign = BitConverter.ToString(dataHashed).Replace("-", "");
