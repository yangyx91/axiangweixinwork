...
namespace weixin.pay
{
    public class WxPayConfig
    {
        ...
        public static readonly string Query_OrderURL = "https://api.mch.weixin.qq.com/pay/orderquery";//微信订单Api 
        ...
        public static readonly string WxPay_PackageValue = "Sign=WXPay";//扩展字段
    }
}
